...
#SECRET SAUCE RECIPE #2: After long researches in the db structure,I can not find the file size. Still it seems the last characters of AgLibraryFile.importHash are correct
